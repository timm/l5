...
local map, obj, per = l.map, l.obj, l.per
...
function Num:pers(t,    a) 
  a=self._has:nums(); return map(t, function(p) return per(a,p) end) end
...
function Num:merges(xys0,nMin,   n,xys1,fillInAnyGaps,loop) 
