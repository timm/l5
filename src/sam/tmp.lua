...
function Cols() return {
  klass=nil, -- for any symbolic klass
  names={},  -- all column names
  x={},      -- for independent columns (that are not skipped)
  y={},      -- for depedent columns (that are not skipped)
  all={}     -- all columns (including the skipped ones)
  } end
